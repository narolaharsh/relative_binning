...
class RealDataJointLikelihood(Likelihood):
    def __init__(self, ifos_dict, fiducial_model, test_model, priors, mode_array, waveform_arguments, total_err):
        ...
        for i in [1, 2]:
            ...
            self.fiducial_waveform[f'image_{i}']['h0'], self.fiducial_waveform[f'image_{i}']['C'] = separate_L_likelkihood.get_binned_detector_response(self.ifos_dict[f'image_{i}'], self.fiducial_model[f'image_{i}'], self.fs[f'image_{i}'], self.waveform_arguments, self.mode_array)


            self.test_waveform[f'image_{i}'] = {}
            self.test_waveform[f'image_{i}']['h0'], self.test_waveform[f'image_{i}']['C']  = separate_L_likelkihood.get_binned_detector_response(self.ifos_dict[f'image_{i}'], self.test_model[f'image_{i}'], self.fs[f'image_{i}'], self.waveform_arguments, self.mode_array)
...
class JointPELikelihood(Likelihood):
    def __init__(self, ifos_dict, fiducial_model, test_model, priors, mode_array, waveform_arguments, total_err, quad_sum = True, grid_choice = 'step'):
        ...
        for i in [1, 2]:
            ...
            self.fiducial_waveform[f'image_{i}'] = {}
            self.fiducial_waveform[f'image_{i}']['hL'], self.fiducial_waveform[f'image_{i}']['C'] = separate_L_likelkihood.get_binned_detector_response(self.ifos_dict[f'image_{i}'], relby_jointpe_conversion(self.fiducial_model[f'image_{i}'], self.waveform_arguments), self.fs, self.waveform_arguments, self.mode_array)


            self.test_waveform[f'image_{i}'] = {}
            self.test_waveform[f'image_{i}']['hL'], self.test_waveform[f'image_{i}']['C']  = separate_L_likelkihood.get_binned_detector_response(self.ifos_dict[f'image_{i}'], relby_jointpe_conversion(self.test_model[f'image_{i}'], self.waveform_arguments), self.fs, self.waveform_arguments, self.mode_array)
