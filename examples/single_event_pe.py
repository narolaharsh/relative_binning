...
lal_max_f = separate_L_likelkihood.lal_f_max(separate_L_likelkihood.relby_conversion(injection_parameters, waveform_arguments))
print('maximum freq of lal', lal_max_f)
############################


likelihood = separate_L_likelkihood.RelativeBinningHOM(ifos, injection_parameters, test_parameters, prior, lal_max_f, mode_array, waveform_arguments, total_err, rebin_c = False, grid_choice = 'step')
